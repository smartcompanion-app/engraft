...
def apply(
    ...
    # Resolve variables: values override defaults. An optional variable
    # (no default declared AND not in values) resolves to None, which
    # causes referencing replace entries to be skipped at apply time.
